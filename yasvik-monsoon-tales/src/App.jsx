...
const AuthenticatedApp = () => {
  ...
  const heroLogoUrl = optimizeSupabasePublicImageUrl(String(resolveSetting(appSettings, 'brand_logo_horizontal_url', cachedSplashLogo)), 520);
  ...
  return (
    <Routes>
      ...
      <Route element={<AppLayout />}>
        ...
        <Route path="/producers" element={<People />} />
